...
wget -O tmp/ad.ips https://raw.githubusercontent.com/felix-fly/v2ray-dnsmasq-dnscrypt/master/ad.ips
...
wget -O tmp/gw.ips https://raw.githubusercontent.com/felix-fly/v2ray-dnsmasq-dnscrypt/master/gw.ips
